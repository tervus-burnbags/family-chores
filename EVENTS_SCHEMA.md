...
- **Carolina Ascent home games are an exception to the pro-sports skip.** The family asked for them by name. Both girls play soccer, tickets are about $18, and the ground is ~15 min from SouthPark. Add the **home** fixtures only — check the club's own schedule page, because aggregators list away matches in the same run — and note the themed nights, which are what distinguish one fixture from another. Away games stay out.
