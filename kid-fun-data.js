...
var KID_TRIVIA = [
  ...
  { question: "What gas do plants breathe in?", choices: ["Oxygen", "Nitrogen", "Carbon Dioxide", "Helium"], answer: 2 },
  { question: "What animal is the tallest in the world?", choices: ["Elephant", "Giraffe", "Horse", "Camel"], answer: 1 },
  { question: "How many continents are there?", choices: ["5", "6", "7", "8"], answer: 2 },
  { question: "What is the hardest natural substance?", choices: ["Gold", "Iron", "Diamond", "Platinum"], answer: 2 },
  { question: "Which fruit has seeds on the outside?", choices: ["Raspberry", "Blueberry", "Strawberry", "Cherry"], answer: 2 },
  { question: "What color do you get mixing blue and yellow?", choices: ["Purple", "Green", "Orange", "Brown"], answer: 1 },
  { question: "What is a group of lions called?", choices: ["Pack", "Herd", "Flock", "Pride"], answer: 3 },
  { question: "How many bones do sharks have?", choices: ["0", "50", "100", "206"], answer: 0 },
  { question: "What is the fastest land animal?", choices: ["Lion", "Cheetah", "Horse", "Greyhound"], answer: 1 },
  { question: "What do caterpillars turn into?", choices: ["Moths only", "Beetles", "Butterflies or moths", "Dragonflies"], answer: 2 },
  { question: "Which planet has the most moons?", choices: ["Jupiter", "Saturn", "Uranus", "Neptune"], answer: 1 },
  { question: "What is the largest animal ever to live?", choices: ["Elephant", "T-Rex", "Blue Whale", "Megalodon"], answer: 2 },
  { question: "What are baby goats called?", choices: ["Calves", "Lambs", "Kids", "Foals"], answer: 2 },
  { question: "How many colors are in a rainbow?", choices: ["5", "6", "7", "8"], answer: 2 },
  { question: "Which bird can fly backwards?", choices: ["Eagle", "Hummingbird", "Penguin", "Owl"], answer: 1 },
  { question: "What is the closest star to Earth?", choices: ["Polaris", "Alpha Centauri", "The Sun", "Sirius"], answer: 2 },
  { question: "How many teeth do adult humans have?", choices: ["28", "30", "32", "34"], answer: 2 },
  { question: "What is the largest desert on Earth?", choices: ["Sahara", "Gobi", "Antarctica", "Arabian"], answer: 2 },
  { question: "What is a baby kangaroo called?", choices: ["Cub", "Kit", "Joey", "Pup"], answer: 2 },
  { question: "Which planet is closest to the Sun?", choices: ["Venus", "Mercury", "Mars", "Earth"], answer: 1 },
  { question: "What do bees make?", choices: ["Silk", "Honey", "Wax only", "Juice"], answer: 1 },
  { question: "How many sides does a hexagon have?", choices: ["5", "6", "7", "8"], answer: 1 },
  { question: "What is the smallest bone in the human body?", choices: ["Toe bone", "Stapes (ear)", "Pinky bone", "Kneecap"], answer: 1 },
  { question: "Where do polar bears live?", choices: ["Antarctica", "Arctic", "Both poles", "Alaska only"], answer: 1 },
  { question: "What is the boiling point of water in Fahrenheit?", choices: ["100 degrees", "200 degrees", "212 degrees", "180 degrees"], answer: 2 },
  { question: "Which animal can change its color?", choices: ["Gecko", "Chameleon", "Iguana", "Frog"], answer: 1 },
  { question: "What is lava called when it's underground?", choices: ["Molten rock", "Magma", "Hot lava", "Core"], answer: 1 },
  { question: "How many wings does a bee have?", choices: ["2", "4", "6", "8"], answer: 1 },
  { question: "What is the largest organ in the human body?", choices: ["Heart", "Brain", "Liver", "Skin"], answer: 3 },
  { question: "Which planet is known for its rings?", choices: ["Jupiter", "Saturn", "Neptune", "Uranus"], answer: 1 },
  { question: "What animal has black and white stripes?", choices: ["Tiger", "Leopard", "Zebra", "Panda"], answer: 2 },
  { question: "How many days are in a leap year?", choices: ["364", "365", "366", "367"], answer: 2 },
  { question: "What is the biggest bird in the world?", choices: ["Eagle", "Albatross", "Ostrich", "Condor"], answer: 2 },
  { question: "What do you call a scientist who studies stars?", choices: ["Biologist", "Astronomer", "Geologist", "Physicist"], answer: 1 },
  { question: "Which animal sleeps the most?", choices: ["Cat", "Sloth", "Koala", "Bear"], answer: 2 },
  { question: "What element does 'O' stand for on the periodic table?", choices: ["Gold", "Osmium", "Oxygen", "Oganesson"], answer: 2 },
  { question: "What fruit do raisins come from?", choices: ["Plums", "Dates", "Grapes", "Figs"], answer: 2 },
  { question: "What is the national bird of the United States?", choices: ["Robin", "Bald Eagle", "Blue Jay", "Hawk"], answer: 1 },
  { question: "How many stomachs does a cow have?", choices: ["1", "2", "3", "4"], answer: 3 },
  { question: "Which sea creature has three hearts?", choices: ["Jellyfish", "Starfish", "Octopus", "Seahorse"], answer: 2 },
  { question: "What is the longest river in the world?", choices: ["Amazon", "Nile", "Mississippi", "Yangtze"], answer: 1 },
  { question: "What are baby owls called?", choices: ["Chicks", "Owlets", "Pups", "Fledglings"], answer: 1 },
  { question: "What shape is a stop sign?", choices: ["Circle", "Square", "Hexagon", "Octagon"], answer: 3 },
  { question: "Which animal can sleep standing up?", choices: ["Cow", "Horse", "Dog", "Goat"], answer: 1 },
  { question: "What is the main ingredient in guacamole?", choices: ["Tomato", "Avocado", "Lime", "Pepper"], answer: 1 },
  { question: "How many Great Lakes are there?", choices: ["3", "4", "5", "6"], answer: 2 },
  { question: "What is the study of dinosaurs called?", choices: ["Archaeology", "Paleontology", "Biology", "Geology"], answer: 1 }
];
