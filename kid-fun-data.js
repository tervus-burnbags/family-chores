...
var HANGMAN_WORDS = [
  ...
  { word: "ROCKET", category: "Thing" },
  { word: "BALLOON", category: "Thing" },
  { word: "TREASURE", category: "Thing" },
  { word: "BLANKET", category: "Thing" },
  { word: "BICYCLE", category: "Thing" },
  { word: "TRUMPET", category: "Thing" },
  { word: "COMPASS", category: "Thing" },
  { word: "LANTERN", category: "Thing" },
  { word: "CRYSTAL", category: "Thing" },
  { word: "MAGNET", category: "Thing" },
  { word: "PUPPET", category: "Thing" },
  { word: "DRAGON", category: "Thing" },
  { word: "WIZARD", category: "Thing" },
  { word: "UNICORN", category: "Thing" }
];

var WOULD_YOU_RATHER = [
  { a: "Be able to fly", b: "Be able to breathe underwater" },
  { a: "Have a pet dragon", b: "Have a pet unicorn" },
  { a: "Eat only pizza forever", b: "Eat only ice cream forever" },
  { a: "Be invisible", b: "Be able to read minds" },
  { a: "Live in a treehouse", b: "Live in a castle" },
  { a: "Be the fastest runner in the world", b: "Be the best swimmer in the world" },
  { a: "Have a tail", b: "Have wings that are too small to fly" },
  { a: "Talk to animals", b: "Speak every human language" },
  { a: "Have spaghetti for hair", b: "Sweat maple syrup" },
  { a: "Be a famous singer", b: "Be a famous athlete" },
  { a: "Have X-ray vision", b: "Have super hearing" },
  { a: "Live in the future", b: "Live in the past" },
  { a: "Be as small as an ant", b: "Be as tall as a giraffe" },
  { a: "Have a magic carpet", b: "Have a time machine" },
  { a: "Never have homework again", b: "Never have chores again" },
  { a: "Be able to talk to your pet", b: "Be able to talk to babies" },
  { a: "Have a robot butler", b: "Have a clone of yourself" },
  { a: "Always smell like cookies", b: "Always smell like flowers" },
  { a: "Be a pirate", b: "Be a ninja" },
  { a: "Have 10 dogs", b: "Have 10 cats" },
  { a: "Be the funniest person alive", b: "Be the smartest person alive" },
  { a: "Only whisper for a day", b: "Only shout for a day" },
  { a: "Live in space", b: "Live under the ocean" },
  { a: "Have feet for hands", b: "Have hands for feet" },
  { a: "Be a superhero", b: "Be a wizard" },
  { a: "Eat a bug", b: "Touch a snake" },
  { a: "Have a slide from your bedroom", b: "Have a trampoline floor in your room" },
  { a: "Be covered in fur", b: "Be covered in scales" },
  { a: "Never brush your teeth again", b: "Never take a bath again" },
  { a: "Have laser eyes", b: "Have a stretchy body" },
  { a: "Only eat breakfast food", b: "Only eat dinner food" },
  { a: "Ride a dolphin to school", b: "Ride an eagle to school" },
  { a: "Have a snow day every Monday", b: "Have summer break be one month longer" },
  { a: "Meet your future self", b: "Meet your past self as a baby" },
  { a: "Be best friends with a celebrity", b: "Be a celebrity yourself" },
  { a: "Have no elbows", b: "Have no knees" },
  { a: "Live in a giant shoe", b: "Live in a giant pumpkin" },
  { a: "Have hiccups forever", b: "Have to sneeze but never be able to" },
  { a: "Be a famous chef", b: "Be a famous inventor" },
  { a: "Have a personal theme song that plays everywhere", b: "Have a spotlight follow you everywhere" },
  { a: "Be able to jump super high", b: "Be able to run super fast" },
  { a: "Have a pet dinosaur", b: "Have a pet whale" },
  { a: "Live without music", b: "Live without movies" },
  { a: "Always be 10 minutes late", b: "Always be 20 minutes early" },
  { a: "Only wear one color forever", b: "Have to wear a costume every day" },
  { a: "Control the weather", b: "Control time" },
  { a: "Have a bottomless bag of candy", b: "Have a bottomless bag of chips" },
  { a: "Be able to freeze time", b: "Be able to rewind time" },
  { a: "Know everything", b: "Be able to do anything" },
  { a: "Have jelly legs", b: "Have noodle arms" }
];

var KID_TRIVIA = [
  { question: "How many continents are there?", choices: ["5", "6", "7", "8"], answer: 2 },
  { question: "What planet do we live on?", choices: ["Mars", "Earth", "Jupiter", "Moon"], answer: 1 },
  { question: "What do caterpillars turn into?", choices: ["Spiders", "Birds", "Butterflies", "Frogs"], answer: 2 },
  { question: "How many sides does a hexagon have?", choices: ["4", "5", "6", "8"], answer: 2 },
  { question: "Which season comes after winter?", choices: ["Summer", "Fall", "Spring", "December"], answer: 2 },
  { question: "What is the largest ocean?", choices: ["Atlantic", "Indian", "Arctic", "Pacific"], answer: 3 },
  { question: "What is the main gas we breathe in?", choices: ["Oxygen", "Steam", "Helium", "Smoke"], answer: 0 },
  { question: "Which animal is a mammal?", choices: ["Frog", "Robin", "Whale", "Lizard"], answer: 2 },
  { question: "How many hours are in one day?", choices: ["12", "18", "24", "30"], answer: 2 },
  { question: "What do bees collect from flowers?", choices: ["Snow", "Nectar", "Sand", "Mud"], answer: 1 },
  { question: "Which shape has no corners?", choices: ["Circle", "Square", "Triangle", "Rectangle"], answer: 0 },
  { question: "What is frozen water called?", choices: ["Steam", "Rain", "Ice", "Fog"], answer: 2 },
  { question: "Which planet is closest to the sun?", choices: ["Mercury", "Earth", "Mars", "Saturn"], answer: 0 },
  { question: "What part of a plant grows underground?", choices: ["Leaf", "Root", "Petal", "Stem"], answer: 1 },
  { question: "How many days are in a week?", choices: ["5", "6", "7", "9"], answer: 2 },
  { question: "Which animal can breathe underwater with gills?", choices: ["Dog", "Fish", "Horse", "Rabbit"], answer: 1 },
  { question: "What do you call the person who writes a book?", choices: ["Painter", "Singer", "Author", "Pilot"], answer: 2 },
  { question: "Which month comes after June?", choices: ["May", "July", "August", "January"], answer: 1 },
  { question: "What do we call water that falls from clouds?", choices: ["Rain", "Sand", "Smoke", "Dust"], answer: 0 },
  { question: "How many quarters make one dollar?", choices: ["2", "3", "4", "5"], answer: 2 },
  { question: "Which animal is known for building dams?", choices: ["Beaver", "Tiger", "Penguin", "Camel"], answer: 0 },
  { question: "What is a baby frog called?", choices: ["Cub", "Tadpole", "Kid", "Foal"], answer: 1 },
  { question: "What is 9 plus 6?", choices: ["14", "15", "16", "17"], answer: 1 },
  { question: "Which season is usually hottest?", choices: ["Winter", "Spring", "Summer", "Fall"], answer: 2 },
  { question: "What do you call a story that is not real?", choices: ["Recipe", "Fiction", "Map", "Poem"], answer: 1 },
  { question: "What is the largest land animal?", choices: ["Giraffe", "Elephant", "Bear", "Horse"], answer: 1 },
  { question: "Which direction does the sun rise?", choices: ["North", "South", "East", "West"], answer: 2 },
  { question: "How many legs does an insect have?", choices: ["4", "6", "8", "10"], answer: 1 },
  { question: "What tool do you use to measure length?", choices: ["Thermometer", "Ruler", "Clock", "Scale"], answer: 1 },
  { question: "Which holiday is in July in the United States?", choices: ["Halloween", "Thanksgiving", "Independence Day", "Valentine's Day"], answer: 2 },
  { question: "What is half of 10?", choices: ["4", "5", "6", "7"], answer: 1 },
  { question: "Which planet is known for its rings?", choices: ["Venus", "Saturn", "Mercury", "Earth"], answer: 1 },
  { question: "What do owls do mostly at night?", choices: ["Sleep", "Fly and hunt", "Build snowmen", "Swim"], answer: 1 },
  { question: "How many months are in one year?", choices: ["10", "11", "12", "13"], answer: 2 },
  { question: "Which one is a solid?", choices: ["Milk", "Air", "Rock", "Rain"], answer: 2 },
  { question: "What is 20 minus 7?", choices: ["11", "12", "13", "14"], answer: 2 },
  { question: "What is the title of the story about a girl and three bears?", choices: ["Cinderella", "Goldilocks", "Rapunzel", "Snow White"], answer: 1 },
  { question: "Which body part pumps blood?", choices: ["Lungs", "Heart", "Stomach", "Brain"], answer: 1 },
  { question: "How many corners does a rectangle have?", choices: ["2", "3", "4", "6"], answer: 2 },
  { question: "What kind of animal is a salmon?", choices: ["Bird", "Fish", "Mammal", "Reptile"], answer: 1 },
  { question: "Which ocean touches the west coast of the United States?", choices: ["Atlantic", "Indian", "Pacific", "Arctic"], answer: 2 },
  { question: "What do you call the red and blue lines on a map that show water?", choices: ["Roads", "Rivers", "Fences", "Clouds"], answer: 1 },
  { question: "What is 8 plus 8?", choices: ["14", "15", "16", "18"], answer: 2 },
  { question: "Which animal lives in the Arctic?", choices: ["Polar bear", "Camel", "Monkey", "Alligator"], answer: 0 },
  { question: "What do plants need from the sun to grow?", choices: ["Moonlight", "Sunlight", "Starlight", "Flashlight"], answer: 1 },
  { question: "How many equal parts are in a half?", choices: ["1", "2", "3", "4"], answer: 1 },
  { question: "Which job helps sick people get better?", choices: ["Chef", "Doctor", "Carpenter", "Librarian"], answer: 1 },
  { question: "What is the name of our galaxy?", choices: ["Milky Way", "Andromeda", "Sunbeam", "Star Circle"], answer: 0 },
  { question: "Which animal lays eggs and also has feathers?", choices: ["Chicken", "Cat", "Dog", "Shark"], answer: 0 },
  { question: "What does a thermometer measure?", choices: ["Time", "Weight", "Temperature", "Distance"], answer: 2 }
];
