...
var KID_TRIVIA = [
  ...
  { question: "What color is a banana?", choices: ["Red", "Blue", "Yellow", "Purple"], answer: 2 },
  { question: "How many fingers do you have?", choices: ["5", "8", "10", "12"], answer: 2 },
  { question: "Which animal says woof?", choices: ["Cat", "Dog", "Duck", "Fish"], answer: 1 },
  { question: "What shape is a ball?", choices: ["Square", "Triangle", "Circle", "Star"], answer: 2 },
  { question: "What do you use to smell?", choices: ["Ears", "Eyes", "Nose", "Toes"], answer: 2 },
  { question: "How many legs does a dog have?", choices: ["2", "3", "4", "6"], answer: 2 },
  { question: "What season do leaves fall?", choices: ["Spring", "Summer", "Fall", "Birthday"], answer: 2 },
  { question: "What color is the sky on a sunny day?", choices: ["Blue", "Pink", "Orange", "Black"], answer: 0 },
  { question: "Which one can fly?", choices: ["Bird", "Chair", "Shoe", "Apple"], answer: 0 },
  { question: "What do bees make?", choices: ["Honey", "Ketchup", "Snow", "Soap"], answer: 0 },
  { question: "How many days are in a week?", choices: ["5", "6", "7", "10"], answer: 2 },
  { question: "Which animal lives in the ocean?", choices: ["Whale", "Cow", "Pig", "Horse"], answer: 0 },
  { question: "What do you wear on your feet?", choices: ["Gloves", "Shoes", "Hat", "Scarf"], answer: 1 },
  { question: "What color do you get from red and blue?", choices: ["Green", "Orange", "Purple", "Brown"], answer: 2 },
  { question: "Which one is a fruit?", choices: ["Carrot", "Apple", "Broccoli", "Corn"], answer: 1 },
  { question: "How many wheels does a bike have?", choices: ["1", "2", "3", "5"], answer: 1 },
  { question: "What do you use to hear?", choices: ["Knees", "Ears", "Hands", "Hair"], answer: 1 },
  { question: "Which animal says meow?", choices: ["Cat", "Cow", "Duck", "Sheep"], answer: 0 },
  { question: "What shape has three sides?", choices: ["Circle", "Square", "Triangle", "Heart"], answer: 2 },
  { question: "What do you do with a toothbrush?", choices: ["Brush teeth", "Comb hair", "Wash dishes", "Paint"], answer: 0 },
  { question: "What color is grass?", choices: ["Green", "Blue", "Silver", "Purple"], answer: 0 },
  { question: "Which animal is very tall with a long neck?", choices: ["Dog", "Giraffe", "Mouse", "Frog"], answer: 1 },
  { question: "What do ducks say?", choices: ["Roar", "Moo", "Quack", "Buzz"], answer: 2 },
  { question: "How many eyes do you have?", choices: ["1", "2", "3", "4"], answer: 1 },
  { question: "Which one is cold?", choices: ["Ice cream", "Soup", "Toast", "Pizza"], answer: 0 },
  { question: "What do you wear on your head?", choices: ["Hat", "Sock", "Belt", "Mitten"], answer: 0 },
  { question: "What color is a stop sign?", choices: ["Red", "Green", "Blue", "Yellow"], answer: 0 },
  { question: "Which animal hops?", choices: ["Kangaroo", "Fish", "Turtle", "Snail"], answer: 0 },
  { question: "How many sides does a square have?", choices: ["3", "4", "5", "6"], answer: 1 },
  { question: "What do you drink when you are thirsty?", choices: ["Water", "Sand", "Pencil", "Blanket"], answer: 0 },
  { question: "Which one shines at night?", choices: ["Moon", "Sofa", "Carrot", "Boot"], answer: 0 },
  { question: "What do chickens lay?", choices: ["Eggs", "Books", "Rocks", "Leaves"], answer: 0 },
  { question: "What color is an orange?", choices: ["Orange", "Gray", "Blue", "Pink"], answer: 0 },
  { question: "Which body part helps you clap?", choices: ["Hands", "Elbows", "Nose", "Ankles"], answer: 0 },
  { question: "What do you sleep in at night?", choices: ["Bed", "Bathtub", "Sandbox", "Fridge"], answer: 0 },
  { question: "Which animal has stripes?", choices: ["Zebra", "Pig", "Whale", "Bunny"], answer: 0 },
  { question: "How many months are in a year?", choices: ["10", "11", "12", "15"], answer: 2 },
  { question: "What do you wear when it rains?", choices: ["Raincoat", "Swimsuit", "Pajamas", "Slippers"], answer: 0 },
  { question: "Which one grows on a tree?", choices: ["Apple", "Pancake", "Spoon", "Toy"], answer: 0 },
  { question: "What color are strawberries?", choices: ["Red", "Blue", "White", "Brown"], answer: 0 },
  { question: "Which season is cold and snowy?", choices: ["Winter", "Summer", "Spring", "Lunch"], answer: 0 },
  { question: "How many legs does a spider have?", choices: ["4", "6", "8", "10"], answer: 2 },
  { question: "What shape is a slice of pizza?", choices: ["Triangle", "Circle", "Square", "Oval"], answer: 0 },
  { question: "Which animal gives us wool?", choices: ["Sheep", "Cat", "Crab", "Goose"], answer: 0 },
  { question: "What do you use to see?", choices: ["Eyes", "Ears", "Mouth", "Shoulders"], answer: 0 },
  { question: "Which one belongs in a sandwich?", choices: ["Bread", "Pebble", "Soap", "Pillow"], answer: 0 },
  { question: "How many feet do you have?", choices: ["1", "2", "3", "4"], answer: 1 },
  { question: "What color is a lemon?", choices: ["Yellow", "Purple", "Brown", "Black"], answer: 0 },
  { question: "Which one is a farm animal?", choices: ["Cow", "Shark", "Tiger", "Seal"], answer: 0 }
];
